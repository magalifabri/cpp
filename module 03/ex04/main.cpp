...
int main()
{
	...
	// supertrap_1.meleeAttack("target dummy");
	supertrap_1.NinjaTrap::meleeAttack("target dummy");
	supertrap_1.FragTrap::rangedAttack("target dummy");
	supertrap_1.vaulthunter_dot_exe("target dummy");
	supertrap_1.ninjaShoebox(ninjatrap_1);
}