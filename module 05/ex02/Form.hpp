...
public:
	...
	int getSignedStatus(void) const {return signedStatus;}
	int getGradeNeededToSign(void) {return gradeNeededToSign;}
	int getGradeNeededToExecute(void) const {return gradeNeededToExecute;}
	void setName(std::string const &nameParam) {name = nameParam;}
	void setGradeNeededToSign(int const &gradeParam) {gradeNeededToSign = gradeParam;}
	void setGradeNeededToExecute(int const &gradeParam) {gradeNeededToExecute = gradeParam;}
